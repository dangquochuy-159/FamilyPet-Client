    ...
    return (
        <section id='sec-policy_page' className="grid_layout wide my-16 flex flex-col gap-8 sm:!my-0 sm:!p-2">
            ...
            <div className="space-y-2">
                ...
                <p className="text-lg">Petshop khuyến khích khách hàng nên kiểm tra sản phẩm trước khi thanh toán, hoặc sau khi nhận được hàng nhằm giúp khách hàng an tâm và thoải mái hơn khi lựa chọn mua sắm tại Petshop.</p>
                <p className="text-xl italic text-[var(--primary-color)] underline">Sản phẩm được đổi trả</p>
                <p className="text-lg">Hàng hóa đổi/trả cần kèm theo hóa đơn mua hàng gốc từ Petshop và còn hạn sử dụng kèm theo:</p>
                ...
                <p className="text-lg">Khi nhận được yêu cầu đổi/trả sản phẩm, Petshop sẽ cố gắng giải quyết trong vòng 24h từ lúc nhận được yêu cầu</p>
            ...
            <div className="space-y-2">
                ...
                <p className="text-lg">Việc thu nhập thông tin trên website của Petshop bao gồm: email, số điện thoại, địa chỉ và họ tên khách hàng</p>
                <p className="text-lg">Dữ liệu sẽ được thu nhập khi khách hàng đăng kí tài khoản hoặc mua hàng trên website </p>
                <p className="text-lg">Đây là các thông tin mà Petshop cần khách hàng cung cấp khi sử dụng dịch vụ nhằm để Petshop liên hệ khi khách hàng mưa sắm tại website</p>
                <p className="text-xl italic text-[var(--primary-color)] underline">Phạm vi sử dụng thông tin</p>
                <p className="text-lg">Petshop sẽ sử dụng thông tin khách hàng cugn cấp để:</p>
                ...
                <p className="text-lg">Khồn sử dụng thông tin khách hàng ngoài mục đích xác nhận và liên hệ có liên quan đến giao dịch tại Petshop</p>
                <p className="text-xl italic text-[var(--primary-color)] underline">Thời gian lưu trữ thông tin</p>
                <p className="text-lg">Dữ liệu cá nhân của khách hàng sẽ được lưu trữ cho đến khi có yêu cầu hủy bỏ hoặc khách hàng yêu cầu hủy bỏ. Còn lại trong mọi trường hợp thông tin cá nhân khách hàng sẽ được bảo mật trên máy chủ của Petshop</p>
                <p className="text-xl italic text-[var(--primary-color)] underline">Cam kết bảo mật thông tin khách hàng</p>
                <p className="text-lg">Thông tin cá nhân của khách hàng trên Petshop được cam kết bảo mật tuyệt đối theo chính sách bảo vệ thông tin cá nhân của Petshop Việc thu thập và sử dụng thông tin của mỗi khách hàng chỉ được thực hiện khi có sự đồng ý của khách hàng đó trừ những trường hợp pháp luật có quy định khác.</p>
            ...
            <div>
                ...
                <ul className="space-y-2 py-2">
                    ...
                    <li className="space-y-2">
                        ...
                        <p className="text-lg">Petshop giao hàng hoả tốc trong ngày với các khách hàng trong TP Hồ Chí Minh và bán kính đến cửa hàng của Petshop dưới 15 km. Khoảng cách lớn hơn nhân viên của chúng tôi sẽ tư vấn cách thức giao hàng thuận tiện nhất cho khách hàng.</p>
