...
function ProductOutstand({ products, priceFilter }) {
    ...
    return (
        <section id='sec-product_outstand'>
            <h2 className='py-2 text-xl font-bold'>Sản phẩm nổi bật</h2>
...
ProductOutstand.propTypes = {
    products: PropTypes.array.isRequired,
    priceFilter: PropTypes.string.isRequired,
}

export default ProductOutstand
